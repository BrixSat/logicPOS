...
{
    class DialogUserProfile : BOBaseDialog
    {
        ...
        {
            this.Title = Utils.GetWindowTitle(resources.CustomResources.GetCustomResources(GlobalFramework.Settings["customCultureResourceDefinition"], "window_title_edit_user_profile"));
            SetSizeRequest(500, 390);
            InitUI();
            InitNotes();
            ShowAll();
        }
        ...
        private void InitUI()
        {
            try
            {
                ...
                //AccessPassword
                CheckButton checkButtonAccessPassword = new CheckButton(resources.CustomResources.GetCustomResources(GlobalFramework.Settings["customCultureResourceDefinition"], "global_accesspassword"));

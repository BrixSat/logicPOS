...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    class DialogUserCommissionGroup : BOBaseDialog
    {
            ...
            : base(pSourceWindow, pTreeView, pFlags, pDialogMode, pXPGuidObject)
        {
            ...
            SetSizeRequest(500, 410);//332 sem o disabled
            InitUI();
            InitNotes();
            ShowAll();
        }
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxCommission = new BOWidgetBox(resources.CustomResources.GetCustomResources(GlobalFramework.Settings["customCultureResourceDefinition"], "global_commission"), entryCommission);

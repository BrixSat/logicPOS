...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    class DialogConfigurationPrintersType : BOBaseDialog
    {
            ...
            : base(pSourceWindow, pTreeView, pFlags, pDialogMode, pXPGuidObject)
        {
            ...
            if (Utils.IsLinux) SetSizeRequest(500, 440);
            else SetSizeRequest(500, 440);
            InitUI();
            InitNotes();
            ShowAll();
        }
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxToken = new BOWidgetBox(resources.CustomResources.GetCustomResources(GlobalFramework.Settings["customCultureResourceDefinition"], "global_DialogConfigurationPrintersTypetoken"), entryToken);
                ...
                //ThermalPrinter
                CheckButton checkButtonThermalPrinter = new CheckButton(resources.CustomResources.GetCustomResources(GlobalFramework.Settings["customCultureResourceDefinition"], "global_printer_thermal_printer"));
